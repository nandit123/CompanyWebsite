...
$("#registerForm").on('submit',function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "http://buytrue.in/companyUser/register",
        data: dataString
...
$("#loginForm").on('submit',function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "http://buytrue.in/companyUser/login",
        data: dataString
    }).always(function(data){
...
$("#addProductForm").on('submit',function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "http://buytrue.in/product/create",
        data: dataString
    }).always(function(data){
...
$("#updateProductForm").on('submit',function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "http://buytrue.in/product/update",
        data: dataString
    }).always(function(data){
...
$("#deleteProductForm").on('submit',function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "http://buytrue.in/product/deleteProduct",
        data: dataString
    }).always(function(data){
        window.location.href = "products";
    });
...
$("#addCodesForm").on('submit',function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "http://buytrue.in/code/addCodes",
        data: dataString
    }).always(function(data){
        if (data.responseText == "added") {
...
$("#updateSettingsForm").on('submit',function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "http://buytrue.in/companyUser/updateCompanyInfo",
        data: dataString
    }).always(function(data){
...
$("#verifyAccountForm").on('submit',function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "http://buytrue.in/companyUser/verify",
        data: dataString
    }).always(function(data){
        setTimeout(function () {
...
$("#forgotPasswordEmailForm").on('submit',function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "http://buytrue.in/companyUser/forgotPassword",
        data: dataString
    }).always(function(data){
        setTimeout(function () {
...
$("#resetPasswordForm").on('submit',function(event) {
    ...
    $.ajax({
        type: "POST",
        url: "http://buytrue.in/companyUser/resetPassword",
